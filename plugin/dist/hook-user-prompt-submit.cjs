...
3. Track each one by calling the anneal_record tool (state: suggested \u2192 approved when the user chooses it \u2192 done once built & verified / deferred if skipped for now / dismissed if not applicable). Anneal maintains .anneal/findings.md for you \u2014 never edit it by hand.
